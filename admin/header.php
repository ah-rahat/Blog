      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  <li>
                      <a <?=$active_page=='index.php'?'class="active"':"" ?>  href="index.php">
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" <?=$active_page=='add-catagory.php'?'class="active"':""?><?=$active_page=='manage-catagory.php'?'class="active"':""?>>
                          <i class="fa fa-laptop"></i>
                          <span>categories</span>
                      </a>
                      <ul class="sub">
                          <li  <?=$active_page=='add-catagory.php'?'class="active"':""?> ><a  href="add-catagory.php">Add catagories</a></li>
                          <li <?=$active_page=='manage-catagory.php'?'class="active"':""?>  ><a  href="manage-catagory.php">manage categories</a></li>
                          
                      </ul>
                  </li>

                  <li class="sub-menu">
                      <a href="javascript:;" <?=$active_page=='add-blog.php'?'class="active"':""?><?=$active_page=='manage-blog.php'?'class="active"':""?>>
                          <i class="fa fa-laptop"></i>
                          <span>blog</span>
                      </a>
                      <ul class="sub">
                          <li  <?=$active_page=='add-blog.php'?'class="active"':""?> ><a  href="add-blog.php">Add blog</a></li>
                          <li <?=$active_page=='manage-blog.php'?'class="active"':""?>  ><a  href="manage-blog.php">manage blog</a></li>
